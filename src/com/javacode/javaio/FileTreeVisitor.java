...
//        Files.walkFileTree(path, new Visitor());
        Files.walkFileTree(path, new CopyFileVisitor(path,
                Paths.get("temp2" + File.separator + "copy")));
    }
...
//
//                Files.move(file, Paths.get(start + File.separator + LocalDate.now().format(DateTimeFormatter.ISO_DATE) + "___" + end));
//            }
//        }
//
//        @Override
